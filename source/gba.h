...
// Load a variable amount of palette data from an array, storing it in palette entries
// from first_entry onwards. data_bytes is the length of the data in bytes.
